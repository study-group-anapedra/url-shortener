...
@Provider
public class CodigoCurtoHandler implements ExceptionMapper<CodigoCurtoNaoDisponivelException> {
    @Context
    private UriInfo uriInfo;

    @Override
    public Response toResponse(CodigoCurtoNaoDisponivelException e) {
